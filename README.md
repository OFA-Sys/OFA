...
* [ ] To integrate more downstream tasks to our OFA framework, now including cross-modal retrieval, data-to-text generation, and other CV tasks. 
* [ ] To release smaller models, including OFA-medium, OFA-tiny, as well as OFA-edge. 
* [ ] To release OFA for Chinese pretrained on extremely large-scale data.
* [ ] To incorporate more modalities, e.g., OFA+audio, OFA+video, etc. 
<br></br>
