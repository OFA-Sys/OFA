...
# News 
* 2022.4.28: Add support of inference on **Transformers**. Feel free to check it out in the "transformers" directory in the branch "feature/add_transformers", as well as checkpoints in [Models](https://huggingface.co/OFA-Sys). 
